...
class FP8BitNetConverter(ModelConverter):
    def __init__(self, job_config: JobConfig, parallel_dims: ParallelDims):
        ...
        try:
            ...
            #     bitnet_training,
            # )
            from torchtitan.patch_ao.fp8_bitnet import (  # noqa: F401
                fp8_bitnet_training,
            )
        ...
        logger.info("FP8 BitNet training active")
    ...
    def convert(self, model: nn.Module):
        ...
        return self.convert_to_fp8_bitnet_training(model)
    ...
    def convert_to_fp8_bitnet_training(self, model: nn.Module):
        """
        ...
        from torchtitan.patch_ao.fp8_bitnet import fp8_bitnet_training
        ...
        logger.info("Swapped to FP8BitNetLinear layers")
...
register_model_converter(FP8BitNetConverter, "fp8_bitnet")
