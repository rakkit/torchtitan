...
class Int8Int8BitNetConverter(ModelConverter):
    def __init__(self, job_config: JobConfig, parallel_dims: ParallelDims):
        ...
        try:
            ...
            #     bitnet_training,
            # )
            from torchtitan.patch_ao.int8int8_bitnet import (  # noqa: F401
    ...
    def convert(self, model: nn.Module):
        ...
        return self.convert_to_int8int8_bitnet_training(model)
    ...
    def convert_to_int8int8_bitnet_training(self, model: nn.Module):
        """
        ...
        from torchtitan.patch_ao.int8int8_bitnet import int8int8_bitnet_training
        ...
        logger.info("Swapped to Int8Int8BitNetLinear layers")
...
register_model_converter(Int8Int8BitNetConverter, "int8int8_bitnet")
