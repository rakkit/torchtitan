...
moe_opt_moe_configs = {
    ...
    # qkvo-norm
    "gauge-d16-w256-qkvo-norm": OPTMoEModel.Config(
        n_layers=16,
        dim=256,
        layer=OPTMoETransformerBlock.Config(
            n_dense_layers=16,
    ...
    # qkvo-norm-head-wise
    "gauge-d16-w256-qkvo-norm-head-wise": OPTMoEModel.Config(
        n_layers=16,
        dim=256,
        layer=OPTMoETransformerBlock.Config(
            n_dense_layers=16,
    ...
    # ffn-mid-norm
    "gauge-d16-w256-ffn-mid-norm": OPTMoEModel.Config(
        n_layers=16,
        dim=256,
        layer=OPTMoETransformerBlock.Config(
            n_dense_layers=16,
