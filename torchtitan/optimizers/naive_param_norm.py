### below is the previous version of Norm calcualtion,
# this version can be used to compute norm for other optimizers
...
from torchtitan.optimizers.distributed_scion import (
    _remove_orig_mod_and_weight_for_p_name,
    DistributedScion,
)
...
def gather_and_merge(local_stats: dict, dst: int = 0):
    # this is the old-implementation of gather_and_merge, which is used to gather the norms of the parameters
