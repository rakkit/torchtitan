...
@triton.jit
def _scaled_int8int8_mm_kernel(
    A_ptr,
    B_ptr,
    C_ptr,
    row_scale_ptr,
...
lib.define(
    "scaled_int8int8_mm(Tensor A, Tensor B, Tensor A_scale, Tensor B_scale) -> Tensor"
)
...
def scaled_int8int8_mm(
    ...
    return torch.ops.torchao.scaled_int8int8_mm(A, B, row_scale, col_scale)


@torch.library.impl(lib, "scaled_int8int8_mm", "Meta")
...
@torch.library.impl(lib, "scaled_int8int8_mm", "CUDA")
def scaled_int8int8_mm_cuda(A: Tensor, B: Tensor, row_scale: Tensor, col_scale: Tensor):
    M, K = A.shape
    _, N = B.shape
    ...
    _scaled_int8int8_mm_kernel[grid](
        A,
        B,
        C,
        row_scale,
